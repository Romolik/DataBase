...
insert into Buyer values (NULL,'Arkadiy', 'Ponomarev', 2);
insert into Buyer values (NULL,'Boris','Nemov', 2);
...
insert into Purchase values (NULL, 1, 1, 1, 1, 2);
insert into Purchase values (NULL, 1, 1, 2, 2, 2);

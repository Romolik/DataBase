...
insert into Users values (NULL, 'Ozon', '123', 'supplier');
insert into Users values (NULL, 'SibirPromTorg', '12', 'supplier');
...
create table Employee (
                          ...
                          Number_Phone varchar2(20) not null unique,
                          Active Number(1,0) not null,
                          FOREIGN KEY (ID_Post)  REFERENCES Post (ID_Post),
                          CHECK (Salary > 0)
);

insert into Employee values (NULL, 1, 1,  500, 'Ivan', 'Ivanov', '89537649060', 1);
insert into Employee values (NULL, 2, 1,  1000, 'Ivan', 'Sergeev', '89537749060', 1);
insert into Employee values (NULL, 1, 1,  600, 'Alina', 'Kuznetsova', '89535667667', 1);
...
insert into Invoice values (NULL,2,to_date('20200325','YYYYMMDD'), 15, 0);
...
create table Request (
                         ...
                         Number_Request NUMBER (20,0) generated always as (ID_Request + 100000) virtual,
                         FOREIGN KEY (ID_Point_of_Sale)  REFERENCES Point_of_Sale (ID_Point_of_Sale),
                         FOREIGN KEY (ID_Product)  REFERENCES Product (ID_Product),
                         CHECK (Number_of_Pieces >= 0),
                         CHECK ("Quantity(weight_in_grams)" >=0)
...
insert into Request(ID_Request, ID_Point_of_Sale, ID_Product,Number_of_Pieces, "Quantity(weight_in_grams)",Status) values (Null, 1, 1, 5, 0, 'Considered');
...
create table Product_Supplier (
                                  ...
                                  "Сost per piece" number(12,4),
                                  "Cost per 100g" number(12,4),
                                  Article_Number NUMBER (20,0) generated always as (ID_Product_Supplier+100000) virtual,
                                  FOREIGN KEY (ID_Type_Product)  REFERENCES Type_Product (ID_Type_Product),
...
insert into Product_Supplier(ID_Product_Supplier,ID_Type_Product,ID_Supplier,Name_Product,
                             Number_of_Pieces,"Quantity(weight_in_grams)",
                             "Сost per piece","Cost per 100g") values (Null, 1, 1, 'Lays', 100, 0, 1.5, 0);
...
insert into Order_shop (ID_Order_shop, ID_Point_of_Sale, ID_Product_Supplier,Id_Product, ID_Invoice, ID_Supplier, "Cost($)", Status) values (Null, 1,1,1,3,1,22.5,'Considered');
